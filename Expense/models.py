...
class Expense(models.Model):
    ...
    expense_image = models.ImageField(
        upload_to="expense_image/", null=True, blank=True)
    ...
    user = models.ForeignKey(
        CustomUser, on_delete=models.DO_NOTHING, related_name='expense_user')
    approved_supervisor = models.ForeignKey(
        CustomUser, on_delete=models.DO_NOTHING, related_name='approved_supervisor', null=True)
    approved_accounts = models.ForeignKey(
        CustomUser, on_delete=models.DO_NOTHING, related_name='approved_accounts', null=True)
