...
def expense_requisition(request):
    ...
    return render(request, 'expense/expense_requisition.html', context={'expense_accounts': expense_accounts, 'paid_accounts': paid_accounts, 'peoples': peoples})
