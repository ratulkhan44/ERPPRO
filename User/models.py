...
class CustomUser(AbstractUser):
    user_role = models.ForeignKey(
        UserRole, on_delete=models.CASCADE, related_name='user_userrole',null=True,blank=True
    )
    ...
    marital_status = models.CharField(
        max_length=240, choices=MARITAL_CHOICES, default=None, null=True)
    blood_group = models.CharField(
        max_length=240, choices=BLOOD_CHOICES, default=None, blank=True, null=True)
